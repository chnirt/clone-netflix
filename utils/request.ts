...
export const nowPlayingUrl = `${BASE_API}/movie/now_playing?${API_KEY}&${LANGUAGE}&${VIDEO}`
...
export const videoUrl = (movie_id: string) =>
  `https://api.themoviedb.org/3/movie/${movie_id}/videos?${API_KEY}&${LANGUAGE}`
