...
export const netflixUrl = `${BASE_API}/discover/tv?${API_KEY}&${LANGUAGE}&with_networks=213`
...
export const actionUrl = `${BASE_API}/discover/movie?${API_KEY}&${LANGUAGE}&with_genres=28`
export const adventureUrl = `${BASE_API}/discover/movie?${API_KEY}&${LANGUAGE}&with_genres=12`
export const animationUrl = `${BASE_API}/discover/movie?${API_KEY}&${LANGUAGE}&with_genres=16`
export const crimeUrl = `${BASE_API}/discover/movie?${API_KEY}&${LANGUAGE}&with_genres=80`
